    ...
    <div class="ticket-container">
        ...
        <div class="ticket-header">
            <div class="club-branding">
                ...
                @else
                    <div class="club-logo" style="display: flex; align-items: center; justify-content: center; font-size: 40px;">
                        🎓
                    </div>
                @endif
            ...
            <div class="ticket-subtitle">Official Entry Pass</div>
        </div>
        ...
        <div class="ticket-body">
            ...
            <div class="event-info">
                ...
                <div class="info-row">
                    ...
                    <span class="info-value">{{ $ticket->club_name }}</span>
                </div>
            </div>
        ...
        <div class="ticket-footer">
            ...
            <div class="terms">
                ...
                Organized by {{ $ticket->club_name }} | For any questions, please contact the event organizer.
            </div>
        </div>
    </div>
</body>
